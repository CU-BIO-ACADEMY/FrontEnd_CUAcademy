...
import { Image, Button, useDisclosure, Card, CardBody, CardFooter, CardHeader } from '@heroui/react';
            ...
            <div className='flex flex-col gap-2'>
                ...
                <div className='flex gap-3'>
                    <div className='flex-1'>
                        <AvatarCard
                            id={id}
                            img='https://i.pinimg.com/474x/7c/b7/dd/7cb7ddaaab0cb10a19286876ec56b060.jpg'
                            regisNow={10}
                            regisMax={32}
                            title='afawdwd'
                            isFull= {isFull}
