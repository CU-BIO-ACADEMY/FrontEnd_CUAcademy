        ...
        <SectionCard>
            ...
            <section className="space-y-3">
                ...
                <ul className="list-disc list-inside space-y-1.5 text-gray-600 ml-2">
                    ...
                    <li>ประวัติการสมัครกิจกรรมและการชำระเงิน (รวมถึงหลักฐานการโอนเงิน)</li>
                </ul>
            </section>
            ...
            <section className="space-y-3">
                ...
                <ul className="list-disc list-inside space-y-1.5 text-gray-600 ml-2">
                    ...
                    <li>ประมวลผลการชำระเงินผ่านการโอนเงินและตรวจสอบหลักฐานการโอน (สลิป)</li>
        ...
        <SectionCard>
            ...
            <section className="space-y-3">
                ...
                <ul className="list-disc list-inside space-y-1.5 text-gray-600 ml-2">
                    ...
                    <li>ชำระเงินค่าสมัครผ่านการโอนเงินพร้อมแนบหลักฐานการโอน</li>
            ...
            <section className="space-y-3">
                ...
                <ul className="list-disc list-inside space-y-1.5 text-gray-600 ml-2">
                    <li>การสมัครกิจกรรมจะสมบูรณ์เมื่อได้โอนเงินพร้อมแนบสลิป และผ่านการตรวจสอบแล้ว</li>
            ...
            <section className="space-y-3">
                ...
                <ul className="list-disc list-inside space-y-1.5 text-gray-600 ml-2">
                    <li>การชำระเงินดำเนินการผ่านการโอนเงินตรงพร้อมแนบหลักฐานการโอน (สลิป)</li>
                    <li>หลักฐานการโอนเงินจะถูกตรวจสอบโดยระบบและ/หรือผู้ดูแลระบบก่อนยืนยันการชำระเงิน</li>
